...
if __name__ == '__main__':
    ...
    parser.add_argument('--accel_weight', type=float, default=None, help="Override accel_distribution_weight")
    parser.add_argument('--jerk_weight', type=float, default=None, help="Override jerk_penalty_weight")
    ...
    if args.accel_weight is not None:
        CONFIG["accel_distribution_weight"] = args.accel_weight
    if args.jerk_weight is not None:
        CONFIG["jerk_penalty_weight"] = args.jerk_weight
